// =============================================================================
// CERTIFICATES COURSE DATA (aggregator)
// -----------------------------------------------------------------------------
// The individual *-course-data.ts files in this folder hold the full certificates
...
//
// `certificateCourses` is the record consumed by src/lib/courses.ts, keyed by the
...
export const certificateCourses: Record<string, CourseContent> = {};
